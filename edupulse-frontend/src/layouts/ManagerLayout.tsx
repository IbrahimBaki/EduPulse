...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/manager/students',      label: 'Students',      Icon: UsersIcon },
  { to: '/manager/teachers',      label: 'Teachers',      Icon: TeachersIcon },
  { to: '/manager/courses',       label: 'Courses',       Icon: BookOpenIcon },
  { to: '/manager/schedule',      label: 'Schedule',      Icon: CalendarIcon },
  { to: '/manager/finance',       label: 'Finance',       Icon: FinanceIcon },
  { to: '/manager/announcements', label: 'Announcements', Icon: MegaphoneIcon },
